...
int InstanceFileReader::getNumVehicles(){
	return this->numVehicles;
}

double InstanceFileReader::getInitialServiceTimeNode(int n){
	return this->nodes[n].getInitialServiceTime();
}

void InstanceFileReader::setInitialServiceTimeNode(double time){
...
double InstanceFileReader::getCost(int i, int j){
